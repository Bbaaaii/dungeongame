...
import dungeonmania.entities.logical.logicalRules.RuleFactory;
...
public class EntityFactory {
    ...
    public void spawnSpider(Game game) {
        ...
        game.register(() -> spider.move(map, game.getPlayer()), Game.AI_MOVEMENT, spider.getId());
    }
    ...
    public void spawnZombie(Game game, ZombieToastSpawner spawner) {
        ...
        map.addEntity(zt);
        game.register(() -> zt.move(map, map.getPlayer()), Game.AI_MOVEMENT, zt.getId());
    }
    ...
    public SnakeHead buildSnake(Position pos) {
        ...
        return new SnakeHead(
            pos, snakeHealth, snakeAttack, snakeAttackArrowBuff,
            snakeHealthTreasureBuff, snakeHealthKeyBuff, pos, null, null, false, false
        );
    }
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        case "bomb":
            ...
            if (jsonEntity.keySet().contains("logic")) {
                return new Bomb(pos, bombRadius, RuleFactory.createRule(jsonEntity.getString("logic")));
            } else {
        ...
        case "light_bulb_off":
            return new LightBulb(pos, RuleFactory.createRule(jsonEntity.getString("logic")));
        case "switch_door":
            return new SwitchDoor(pos, RuleFactory.createRule(jsonEntity.getString("logic")));
        case "wire":
            return new Wire(pos);
        default:
            return null;
