...
public class GameMap {
    ...
    private void initRegisterMovables() {
        ...
        enemies.forEach(e -> {
            game.register(() -> e.move(this, player), Game.AI_MOVEMENT, e.getId());
        });
    }
    ...
    public List<Entity> getEdibles() {
        return getEntities().stream().filter(Entity::isEdible).collect(Collectors.toList());
    }
